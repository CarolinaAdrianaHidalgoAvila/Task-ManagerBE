...
public class TaskServiceTest {
    ...
    public void testCreate() {
        // Arrange
        TaskDTO taskDTO = new TaskDTO("uuid", "TaskName", "TaskDescription", "Category", null, "Status");
    ...
    public void testEdit() {
        // Arrange
        TaskDTO taskDTO = new TaskDTO("uuid", "UpdatedTaskName", "UpdatedTaskDescription", "UpdatedCategory", null, "UpdatedStatus");
